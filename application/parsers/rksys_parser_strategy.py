"""
RKSys File Parser Strategy
=============================

Module path:
    src/application/parsers/rksys_parser_strategy.py
...
class RksysParserStrategy(ParserStrategy):
    """
    Concrete ParserStrategy for RKSys.dat files.
